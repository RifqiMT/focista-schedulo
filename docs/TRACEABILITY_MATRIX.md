...
|---|---|---|---|---|---|
| FR-01 | Profile-scoped views | Persona A | US-101 | `frontend/src/App.tsx`, `frontend/src/components/ProfileManagement.tsx`, backend profile/task/project filters | profile scope smoke tests |
...
| FR-07 | Progress and insights analytics | Persona C | US-401, US-402 | `/api/stats`, `/api/productivity-insights`, `GamificationPanel.tsx`, `ProductivityAnalysisModal.tsx` | endpoint + UI parity checks |
